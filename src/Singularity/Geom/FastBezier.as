package Singularity.Geom
{
   ...
   public class FastBezier
   {
      ...
      private var __coef:Singularity.Geom.Cubic;
      ...
      public function FastBezier()
      {
         ...
         this.__coef = new Singularity.Geom.Cubic();
         this.__count = 0;
      ...
      private function __inflect() : Number
      {
         ...
         _loc11_ = _loc11_ > 0 && _loc11_ < 1 ? _loc11_ : -1;
         _loc12_ = _loc12_ > 0 && _loc12_ < 1 ? _loc12_ : -1;
         if(_loc11_ != -1 && _loc12_ != -1)
         {
            _loc13_ = Math.min(_loc11_,1 - _loc11_);
            _loc14_ = Math.min(_loc12_,1 - _loc12_);
            return _loc13_ < _loc14_ ? _loc12_ : _loc11_;
         }
      ...
      private function __intersect(param1:Array) : void
      {
         ...
         if(_loc4_ <= Consts.ZERO_TOL)
         {
            ...
            this.__pY = _loc5_ <= Consts.ZERO_TOL ? param1[0] + 3 * (param1[1] - param1[0]) : _loc7_ * (param1[0] - param1[6]) + param1[7];
         }
         else if(_loc5_ <= Consts.ZERO_TOL)
         {
            this.__pX = param1[6];
            _loc6_ = (param1[3] - param1[1]) / _loc2_;
            this.__pY = _loc4_ <= Consts.ZERO_TOL ? param1[4] + 3 * (param1[4] - param1[6]) : _loc6_ * (param1[6] - param1[0]) + param1[1];
         }
