package fl.transitions
{
   ...
   public class Transition extends EventDispatcher
   {
      ...
      public function Transition(param1:MovieClip, param2:Object, param3:fl.transitions.TransitionManager)
      {
         super();
         this.content = param1;
      ...
      public function set manager(param1:fl.transitions.TransitionManager) : void
      {
         if(this._manager)
         {
