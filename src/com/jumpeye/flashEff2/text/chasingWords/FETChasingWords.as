package com.jumpeye.flashEff2.text.chasingWords
{
   ...
   public class FETChasingWords extends IFlashEffText
   {
      ...
      private function getMotionFilter(param1:*, param2:*) : *
      {
         ...
         var _loc7_:Number = axe == "x" ? param1 : 0;
         var _loc8_:Number = axe == "x" ? 0 : param1;
      ...
      protected function startTransition(param1:Boolean = true) : void
      {
         ...
         var _loc8_:Number = Number(Number(this.preset) || 1);
         if(Number(_loc8_) > 4)
         {
            _loc8_ = 1;
         }
         ...
         angle = axe == "x" ? 0 : 90;
         sign = _loc8_ == 1 || _loc8_ == 3 ? -1 : 1;
         distance = param1 ? trailDistance * sign : -trailDistance * sign;
         owner.elements = [];
