package anifire.creator.theme
{
	...
	public class CharThumb extends Thumb implements ICharProduct
	{
		...
		private var _actions:Vector.<anifire.creator.theme.Action>;
		private var _actionLookup:Object;
		private var _motions:Vector.<anifire.creator.theme.Motion>;
		private var _motionLookup:Object;
		private var _facials:Vector.<anifire.creator.theme.Facial>;
		private var _facialLookup:Object;
		private var _libraries:UtilHashBytes;
		private var _defaultTalkAction:anifire.creator.theme.Action;
		private var _defaultAction:anifire.creator.theme.Action;
		private var _defaultMotion:anifire.creator.theme.Motion;
		...
		private var _propThumb:anifire.creator.theme.PropThumb;
		...
		public function CharThumb()
		{
			...
			this._facials = new Vector.<anifire.creator.theme.Facial>();
			this._facialLookup = {};
		...
		{
			this._actions = new Vector.<anifire.creator.theme.Action>();
			this._actionLookup = {};
			this._motions = new Vector.<anifire.creator.theme.Motion>();
			this._motionLookup = {};
		...
		public function addAction(param1:anifire.creator.theme.Action) : void
		{
		...
		private function createActionByXML(param1:XML) : anifire.creator.theme.Action
		{
			var _loc2_:anifire.creator.theme.Action;
			var _loc3_:anifire.creator.theme.Motion;
			var _loc4_:XML;
			...
			var _loc9_:Array;
			var _loc10_:Number;
			if(param1.name().localName == anifire.creator.theme.Motion.XML_NODE_NAME)
			{
				_loc6_ = true;
			}
			if(_loc6_)
			{
				_loc3_ = new anifire.creator.theme.Motion(this,param1.@id,param1.@name,param1.@totalframe,param1.@enable,param1.@aid);
			...
			if(_loc9_)
			{
				_loc2_ = new anifire.creator.theme.SequentialAction(this,param1.@id,param1.@name,param1.@totalframe,param1.@enable,param1.@aid,_loc5_);
				SequentialAction(_loc2_).actionSequence.init(_loc9_);
			}
			else
			{
				_loc2_ = new anifire.creator.theme.Action(this,param1.@id,param1.@name,param1.@totalframe,param1.@enable,param1.@aid,_loc5_);
			}
		...
		public function getActionById(param1:String) : anifire.creator.theme.Action
		{
			var _loc2_:anifire.creator.theme.Action = this._actionLookup[param1];
			if(!_loc2_)
			{
		...
		public function getActionAt(param1:int) : anifire.creator.theme.Action
		{
			return this._actions[param1] as anifire.creator.theme.Action;
		}
		...
		public function get facials() : Vector.<anifire.creator.theme.Facial>
		{
			return this._facials;
		}
		
		public function addFacial(param1:anifire.creator.theme.Facial) : void
		{
			this._facials.push(param1);
			this._facialLookup[param1.id] = param1;
		}
		
		public function getFacialById(param1:String) : anifire.creator.theme.Facial
		{
			return this._facialLookup[param1];
		}
		
		public function getFacialAt(param1:int) : anifire.creator.theme.Facial
		{
			return this._facials[param1];
		}
		
		public function getMotionById(param1:String) : anifire.creator.theme.Motion
		{
			var _loc2_:anifire.creator.theme.Motion = this._motionLookup[param1];
			if(!_loc2_)
			{
		...
		public function addMotion(param1:anifire.creator.theme.Motion) : void
		{
			this._motions.push(param1);
			this._motionLookup[param1.id] = param1;
		}
		
		public function getMotionAt(param1:int) : anifire.creator.theme.Motion
		{
		...
		public function get motions() : Vector.<anifire.creator.theme.Motion>
		{
			return this._motions;
		}
		
		public function get defaultTalkAction() : anifire.creator.theme.Action
		{
			var action:XML = null;
		...
		public function get defaultMotion() : anifire.creator.theme.Motion
		{
		...
		override public function deSerialize(themeChar:XML, theme:ITheme, param3:Boolean = false) : void
		{
			...
			var _loc6_:XML;
			var _loc7_:XML;
			var _loc8_:anifire.creator.theme.Facial;
			_loc10_ = 0;
		...
		{
			var _loc2_:int = 0;
			var _loc3_:anifire.creator.theme.Action = null;
			var _loc4_:anifire.creator.theme.Motion = null;
			...
			if(theme.id == "ugc")
			{
				if(this.isSWFCharacter())
				{
					...
					{
						_loc3_ = this._actions[_loc2_] as anifire.creator.theme.Action;
						if(!_loc3_.imageData)
						{
							return false;
						}
					...
					{
						if(!(_loc4_ = this.motions[_loc2_] as anifire.creator.theme.Motion).imageData)
						{
							return false;
						}
						_loc2_++;
		...
		public function loadAction(param1:Behavior = null, param2:Boolean = false) : void
		{
			...
			{
				if(param1 is anifire.creator.theme.Action)
				{
				...
				else if(param1 is anifire.creator.theme.Facial)
				{
		...
		override public function mergeThumb(param1:IThumb) : void
		{
			if(param1.theme.id == this.theme.id && param1.id == this.id)
			{
				...
				while(_loc3_ < CharThumb(param1).motions.length)
				{
					...
					{
						_loc5_.thumb = this;
						this.addMotion(_loc5_ as anifire.creator.theme.Motion);
					}
					_loc3_++;
				}
				_loc2_ = 0;
				...
				while(_loc3_ < CharThumb(param1).facials.length)
				{
					...
					{
						_loc5_.thumb = this;
						this.addFacial(_loc5_ as anifire.creator.theme.Facial);
					}
					_loc3_++;
				}
				this.xml = param1.xml;
		...
		override public function loadImageDataComplete(param1:Event) : void
		{
			...
			{
				this._propThumb = this.theme.getPropThumbById(this.propXML[0].@id) as anifire.creator.theme.PropThumb;
		...
		public function createCCHeadPropThumb() : anifire.creator.theme.PropThumb
		{
			var _loc1_:anifire.creator.theme.PropThumb = new anifire.creator.theme.PropThumb();
			_loc1_.initAsCCHeadProp(this,this.ccThemeModel);
			return _loc1_;
		}
		
		public function getHeadPropThumb() : anifire.creator.theme.PropThumb
		{
			var _loc1_:* = this.id + ".head";
			var _loc2_:Theme = theme as Theme;
			var _loc3_:anifire.creator.theme.PropThumb = _loc2_.getPropThumbById(_loc1_) as anifire.creator.theme.PropThumb;
			if(!_loc3_)
			{
