package com.jumpeye.flashEff2.text.fe3D.camFocus
{
   ...
   public class FET3DCamFocus extends IFlashEffText
   {
      ...
      protected function startTransition(param1:Boolean) : void
      {
         ...
         var _loc22_:Number = Number(_loc14_.teorecticSpace);
         _loc6_ = 0;
         while(_loc6_ < _loc3_)
         {
            _loc25_ = uint(_loc2_[_loc6_].length);
            _loc7_ = 0;
            while(_loc7_ < _loc25_)
            {
               ...
               _loc28_ = Number(_loc26_.width);
               _loc29_ = Number(_loc26_.height);
               _loc30_ = Number(_loc26_.x);
               _loc31_ = Number(_loc26_.y);
