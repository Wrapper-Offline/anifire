package anifire.skins
{
   ...
   public class ColorInputPanelHueSliderTrackSkin extends SparkSkin implements IBindingClient, IStateClient2
   {
      ...
      public function ColorInputPanelHueSliderTrackSkin()
      {
         ...
         this._embed_mxml__styles_images_colorpalette_hue_slider_bg_png_2086678210 = anifire.skins.ColorInputPanelHueSliderTrackSkin__embed_mxml__styles_images_colorpalette_hue_slider_bg_png_2086678210;
         ...
         {
            return anifire.skins.ColorInputPanelHueSliderTrackSkin[param1];
         },bindings,watchers);
      ...
      {
         anifire.skins.ColorInputPanelHueSliderTrackSkin._watcherSetupUtil = param1;
      }
