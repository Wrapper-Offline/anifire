      ...
      protected function startTransition(param1:Boolean = true) : void
      {
         ...
         while(_loc4_ < _loc3_)
         {
            ...
            while(_loc5_ < _loc18_)
            {
               ...
               {
                  _loc21_ = uint(_loc19_.elementTimeline.push({
                  ...
                  _loc23_ = String(_loc19_.effect[_loc20_]);
                  if(!(propOwner.timeline[_loc23_] is Array))
                  {
                     ++propOwner.timeline.len;
                     _loc24_ = uint(propOwner.timeline.frames.push([]));
         ...
         while(_loc4_ < propOwner.timeLen)
         {
            ...
            while(_loc5_ < propOwner.timeline.frames[_loc4_].length)
            {
               ...
               _loc27_ = String(_loc19_.effect[_loc26_.effectIndex]);
               ...
               {
                  if((_loc28_ = String(_loc19_.effect[_loc26_.effectIndex])) == "up" || _loc28_ == "down")
                  {
