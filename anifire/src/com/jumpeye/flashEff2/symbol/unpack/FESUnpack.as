package com.jumpeye.flashEff2.symbol.unpack
{
   ...
   public class FESUnpack extends IFlashEffSymbol
   {
      ...
      protected function startTransition(param1:String) : void
      {
         ...
         boundsObj = this.target.getBounds(this.target);
      ...
      {
         param1.x += param1.texture.width / 2;
         var _loc2_:Number = Number(param1.texture.width);
         var _loc3_:Number = Number(param1.texture.height);
