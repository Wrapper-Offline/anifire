package com.jumpeye.flashEff2.text.fe3D.camMatrix
{
   ...
   public class FET3DCamMatrix extends IFlashEffText
   {
      ...
      protected function motionChange() : void
      {
         ...
         var _loc1_:Number = Number(this.tweenObject.prop);
         var _loc2_:Number = Number(this.tweenObject.lastProp);
      ...
      protected function startTransition(param1:Boolean = true) : void
      {
         ...
         var _loc17_:Number = Number(this.component.targetOwner.width);
         var _loc18_:Number = Number(this.component.targetOwner.height);
         ...
         {
            _loc19_ = uint(_loc2_[_loc5_].length);
            _loc6_ = 0;
            while(_loc6_ < _loc19_)
            {
               ...
               _loc22_ = Number(_loc20_.clip.width);
               _loc23_ = Number(_loc20_.clip.height);
               _loc24_ = Number(_loc20_.clip.x);
               _loc25_ = Number(_loc20_.clip.y);
               _loc26_ = 0;
