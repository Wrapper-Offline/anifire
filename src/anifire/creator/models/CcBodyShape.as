package anifire.creator.models
{
   ...
   public class CcBodyShape
   {
      ...
      public function getActionByIndex(param1:int) : anifire.creator.models.CcAction
      {
         return this._actions.getValueByIndex(param1) as anifire.creator.models.CcAction;
      }
      
      public function getActionById(param1:String) : anifire.creator.models.CcAction
      {
         return this._actions.getValueByKey(param1) as anifire.creator.models.CcAction;
      }
      
      private function addAction(param1:anifire.creator.models.CcAction) : void
      {
         this._actions.push(param1.id,param1);
      }
      
      public function getLibraryByIndex(param1:int) : anifire.creator.models.CcLibrary
      {
         return this._libraries.getValueByIndex(param1) as anifire.creator.models.CcLibrary;
      }
      
      public function getLibraryById(param1:String) : anifire.creator.models.CcLibrary
      {
         return this._libraries.getValueByKey(param1) as anifire.creator.models.CcLibrary;
      }
      
      private function addLibrary(param1:anifire.creator.models.CcLibrary) : void
      {
         this._libraries.push(param1.type,param1);
      }
      
      private function addComponentThumb(param1:anifire.creator.models.CcComponentThumb) : void
      {
         ...
         if(_loc2_ == null)
         {
            ...
            {
               _loc3_ = new anifire.creator.models.CcLibrary();
      ...
      public function deserialize(param1:XML, param2:String, param3:anifire.creator.models.CcTheme = null) : void
      {
         var _loc4_:XML = null;
         var _loc5_:XML = null;
         var _loc6_:anifire.creator.models.CcComponentThumb = null;
         var _loc7_:anifire.creator.models.CcAction = null;
         ...
         for each(_loc5_ in param1.child(anifire.creator.models.CcComponentThumb.XML_NODE_NAME))
         {
            (_loc6_ = new anifire.creator.models.CcComponentThumb()).deSerialize(_loc5_,this.themeId,anifire.creator.models.CcComponentThumb.PARENT_TYPE_BODYSHAPE,this.id);
            this.addComponentThumb(_loc6_);
         }
         for each(_loc5_ in param1.child(anifire.creator.models.CcAction.XML_NODE_NAME))
         {
            if(_loc5_.@enable != "N")
            {
               (_loc7_ = new anifire.creator.models.CcAction()).deserialize(_loc5_);
               this.addAction(_loc7_);
            }
         }
         for each(_loc4_ in param1.child(anifire.creator.models.CcAction.PACK_XML_NODE_NAME))
         {
            if(_loc4_.@is_premium != "Y" && _loc4_.@enable == "Y")
            {
               for each(_loc5_ in _loc4_.child(anifire.creator.models.CcAction.XML_NODE_NAME))
               {
                  if(!(Boolean(_loc5_.hasOwnProperty("@group")) && _loc5_.@name != "1"))
                  {
                     (_loc7_ = new anifire.creator.models.CcAction()).deserialize(_loc5_);
                     this.addAction(_loc7_);
                  }
         ...
         for each(_loc5_ in param1.child(anifire.creator.models.CcLibrary.XML_NODE_NAME))
         {
            (_loc6_ = new anifire.creator.models.CcComponentThumb()).deSerialize(_loc5_,this.themeId,anifire.creator.models.CcComponentThumb.PARENT_TYPE_BODYSHAPE,this.id);
            this.addComponentThumb(_loc6_);
         }
