package com.jumpeye.flashEff2.text.elasticScale
{
   ...
   public class FETElasticScale extends IFlashEffText
   {
      ...
      internal function motionChange(param1:*, param2:*, param3:*) : *
      {
      ...
      internal function motionChangeBlur(param1:*) : *
      {
      ...
      protected function startTransition(param1:String) : void
      {
         ...
         var _loc2_:Number = Number(Number(this.preset) || 12);
      ...
      internal function blurEffect(param1:*, param2:Number, param3:Number, param4:* = 3) : *
      {
      ...
      protected function clearProperties() : void
      {
         ...
         {
            objMatrix = this.component.absMatrix;
            _loc1_ = uint(owner.elements.length);
            i = 0;
            while(i < _loc1_)
            {
               _loc2_ = uint(owner.elements[i].length);
               j = 0;
               while(j < _loc2_)
               {
      ...
      internal function motionFinish(param1:*) : *
      {
         ++tweensFinished;
         param1.filters = [];
