package com.jumpeye.flashEff2.utils.distort
{
   ...
   public class JDistortImage
   {
      ...
      private function addTriangle(param1:Object, param2:Object, param3:Object) : void
      {
         ...
         var _loc10_:Object = {};
         _loc4_ = Number(param1.x);
         _loc5_ = Number(param1.y);
         _loc6_ = Number(param2.x);
         _loc7_ = Number(param2.y);
         _loc8_ = Number(param3.x);
         _loc9_ = Number(param3.y);
      ...
      private function render() : void
      {
         ...
         while(--_loc13_ > -1)
         {
            ...
            _loc4_ = _loc10_[2];
            _loc12_ = _loc10_[3];
            _loc11_.a = (_loc3_.sx - (_loc5_ = Number(_loc2_.sx))) * _loc8_;
            _loc11_.b = (_loc3_.sy - (_loc6_ = Number(_loc2_.sy))) * _loc8_;
