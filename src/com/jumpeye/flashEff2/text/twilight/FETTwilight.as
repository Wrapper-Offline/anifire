package com.jumpeye.flashEff2.text.twilight
{
   ...
   public class FETTwilight extends IFlashEffText
   {
      ...
      private var cloud:com.jumpeye.flashEff2.text.twilight.JMaskCloud;
      ...
      {
         var _loc2_:Number = Number(param1.pos);
      ...
      public function set radius(param1:Number) : void
      {
         ...
         this._radius = Number(param1) || 1;
      }
      
      private function cloudChange(param1:com.jumpeye.flashEff2.text.twilight.JMaskCloud) : void
      {
      ...
      protected function startTransition(param1:Boolean = true) : void
      {
         ...
         this.cloud = new com.jumpeye.flashEff2.text.twilight.JMaskCloud(this.target.width,this.target.height);
