package Singularity.Geom
{
   ...
   public class BezierSpline extends Composite
   {
      ...
      private var __controlCage:Singularity.Geom.BezierSplineControl;
      ...
      public function BezierSpline()
      {
         ...
         this.__controlCage = new Singularity.Geom.BezierSplineControl();
      ...
      {
         var _loc2_:Number = Number(this.__bezier[this.__index].getXPrime(param1));
         var _loc3_:Number = Number(this.__bezier[this.__index].getYPrime(param1));
      ...
      override public function draw(param1:Number = 1, param2:Number = 3, param3:Number = 3, param4:Number = 15) : void
      {
      ...
      override public function arcLengthAt(param1:Number) : Number
      {
         ...
         var _loc4_:Number = (_loc4_ = param1 < 0 ? 0 : param1) > 1 ? 1 : _loc4_;
         var _loc5_:Number;
      ...
      {
         var _loc2_:Number = param1 < 0 ? 0 : param1;
