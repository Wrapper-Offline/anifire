package com.jumpeye.flashEff2.text.fe3D.camXYZ
{
   ...
   public class FET3DCamXYZ extends IFlashEffText
   {
      ...
      protected function startTransition(param1:Boolean) : void
      {
         ...
         var _loc19_:Number = Number(this.component.textOwnerClip.width);
         var _loc20_:Number = Number(this.component.textOwnerClip.height);
         ...
         var _loc21_:Number = Number(_loc14_.teorecticSpace);
         _loc6_ = 0;
         while(_loc6_ < _loc3_)
         {
            _loc22_ = uint(_loc2_[_loc6_].length);
            _loc7_ = 0;
            while(_loc7_ < _loc22_)
            {
               _loc23_ = _loc2_[_loc6_][_loc7_];
               _loc24_ = this.space.pushItem(_loc23_);
               _loc25_ = Number(_loc23_.width);
               _loc26_ = Number(_loc23_.height);
               _loc27_ = Number(_loc23_.x);
               _loc28_ = Number(_loc23_.y);
