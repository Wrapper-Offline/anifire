   ...
   public class CcEditUiController extends EventDispatcher
   {
      ...
      public function initUi(editUI:ICcEditUiContainer) : void
      {
        ...
        // this.editUi.eui_buttonBar.btnRedo.enabled = this.editUi.eui_buttonBar.btnUndo.enabled = false;
         ...
         // this.editUi.eui_componentTypeChooser.addEventListener(CcButtonBarEvent.SAVE_BUTTON_CLICK,this.onUserClickSaveButton);
         // this.editUi.eui_colorPicker.addEventListener(CcColorPickerEvent.COLOR_CHOSEN,this.onUserChooseColor);
        // this.editUi.eui_componentThumbChooser.thumbFilter = this._cfg.defaultThumbFilter;
         // this.editUi.eui_componentThumbChooser.addEventListener(CcComponentThumbChooserEvent.COMPONENT_THUMB_CHOSEN,this.onUserChooseThumb);
         // this.editUi.eui_componentThumbChooser.addEventListener(CcComponentThumbChooserEvent.NONE_COMPONENT_THUMB_CHOSEN,this.onUserChooseNullThumb);
      ...
      {
         this.editUi.eui_buttonBar.currentState = "editor";
      }
      ...
      public function resetCCAction() : void
      {
         ...
         this.editUi.eui_charPreviewer.initByCcChar(this.ccChar,this.currentTheme.getCharacterDefaultActionId(this.ccChar.bodyShapeId));
      }
      ...
      private function onUserChooseDecoration(event:CcSelectedDecorationEvent) : void
      {
         ...
         // this.editUi.eui_colorPicker.addComponentType(ccComponent,ccComponent.type,this.currentTheme,this.ccChar);
      ...
      public function start(bodyModel:CCBodyModel, charCopyMode:Boolean) : void
      {
         ...
         var order:Array = this.ccChar.version == 1 ? CcLibConstant.COMPONENT_TYPE_CHOOSER_ORDERING_VER1 : CcLibConstant.COMPONENT_TYPE_CHOOSER_ORDERING_VER2;
      ...
      private function switchComponentType(type:String, param2:Boolean) : void
      {
         ...
         // while(_loc7_ < _loc6_)
         // {
         //    var _loc9_:CcComponent = this.ccChar.getUserChosenComponentByIndex(_loc7_);
         //    if(_loc5_.indexOf(_loc9_.componentThumb.type) >= 0 && CcLibConstant.ALL_MULTIPLE_COMPONENT_TYPES.indexOf(type) == -1 || _loc9_.componentThumb.type == CcLibConstant.COMPONENT_TYPE_BODYSHAPE && _loc5_.indexOf(CcLibConstant.COMPONENT_TYPE_FACESHAPE) >= 0)
         //    {
         //       this.editUi.eui_colorPicker.addComponentType(_loc9_,_loc9_.componentThumb.type,this.currentTheme,this.ccChar);
         //       this.editUi.eui_colorPicker.addComponentThumb(_loc9_,_loc9_.componentThumb,this.currentTheme,this.ccChar);
         //       this.editUi.eui_thumbPropertyInspector.init(_loc9_,this.userLevel);
         //    }
         //    _loc7_++;
         // }
         // var _loc8_:int = 0;
         ...
         // {
         //    var _loc10_:CcLibrary = this.ccChar.getUserChosenLibraryByIndex(_loc8_);
         //    if(_loc5_.indexOf(_loc10_.type) > -1)
         //    {
         //       this.editUi.eui_colorPicker.addLibraryType(_loc10_,this.currentTheme,this.ccChar);
         //    }
         //    _loc8_++;
         // }
      }
      ...
      private function onUserChooseColor(param1:CcColorPickerEvent) : void
      {
         ...
         // this.editUi.eui_charPreviewer.updateColor(_loc2_);
      ...
      private function onUserChooseThumb(param1:CcComponentThumbChooserEvent) : void
      {
         ...
         //    this.editUi.eui_colorPicker.addComponentType(_loc3_,_loc3_.componentThumb.type,this.currentTheme,this.ccChar);
         //    this.editUi.eui_colorPicker.addComponentThumb(_loc3_,_loc3_.componentThumb,this.currentTheme,this.ccChar);
         // }
         // this.editUi.eui_colorPicker.addComponentType(_loc2_,_loc2_.componentThumb.type,this.currentTheme,this.ccChar);
      ...
      private function onUserChooseCloth(param1:CcComponentThumbChooserEvent) : void
      {
         ...
         // this.editUi.eui_colorPicker.addComponentType(_loc3_,CcLibConstant.COMPONENT_TYPE_UPPER_BODY,this.currentTheme,this.ccChar);
         // this.editUi.eui_colorPicker.addComponentThumb(_loc3_,_loc3_.componentThumb,this.currentTheme,this.ccChar);
         // _loc3_ = this.ccChar.getUserChosenComponentByComponentType(CcLibConstant.COMPONENT_TYPE_LOWER_BODY)[0] as CcComponent;
         // this.editUi.eui_colorPicker.addComponentType(_loc3_,CcLibConstant.COMPONENT_TYPE_LOWER_BODY,this.currentTheme,this.ccChar);
         // this.editUi.eui_colorPicker.addComponentThumb(_loc3_,_loc3_.componentThumb,this.currentTheme,this.ccChar);
      }
      ...
      private function onUserChooseThumbCommon(param1:CCComponentModel, param2:Boolean = false) : void
      {
      ...
      private function onUserChooseNullThumb(event:CcComponentThumbChooserEvent) : void
      {
         // this.resetPanels();
         // var _loc2_:CcComponent = new CcComponent();
         // _loc2_.xscale = _loc2_.yscale = CcCharacter.getComponentScaling(this.ccChar.bodyShape.bodyType);
         // _loc2_.componentThumb = event.componentThumb;
         // if(CcLibConstant.GET_COMPONENT_RELATED_LIBRARY(event.noneComponentThumbType))
         // {
         //    this.ccChar.removeUserChosenComponentByType(CcLibConstant.GET_COMPONENT_RELATED_LIBRARY(event.noneComponentThumbType));
         // }
         // this.ccChar.removeUserChosenComponentByType(event.noneComponentThumbType);
         // this.editUi.eui_charPreviewer.initByCcChar(this.ccChar,this.ccChar.bodyShape.thumbnailActionId);
         // this.editUi.eui_colorPicker.destroy();
         // this.editUi.eui_colorPicker.addComponentType(_loc2_, event.noneComponentThumbType, this.currentTheme,this.ccChar);
         // this.editUi.eui_thumbPropertyInspector.destroy();
         // this.addCommand(this.ccChar);
      ...
      {
         this.editUi.eui_buttonBar.refreshRole();
      }
