package com.jumpeye.effects
{
   ...
   public dynamic class JMaskDistort extends Sprite
   {
      ...
      private var map2:com.jumpeye.effects.JColorMap;
      ...
      private function createChildren(param1:*) : void
      {
         ...
         map1 = new com.jumpeye.effects.JColorMap(dissolveType,this.wid,this.hig,baseX,baseY);
         this.addChild(map1);
         map1.visible = false;
         map2 = new com.jumpeye.effects.JColorMap(dissolveType,this.wid,this.hig,baseX,baseY);
         this.addChild(map2);
         map2.visible = false;
         bit2 = getBitmap(map2);
