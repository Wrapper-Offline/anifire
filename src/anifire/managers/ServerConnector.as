package anifire.managers
{
	...
	public class ServerConnector extends EventDispatcher
	{
		...
		private static var _instance:anifire.managers.ServerConnector;
		
		public static const TYPE_FONT:String = "font";
		
		private static var _configManager:anifire.managers.AppConfigManager = anifire.managers.AppConfigManager.instance;
		...
		public static function get instance() : anifire.managers.ServerConnector
		{
			if(!_instance)
			{
				_instance = new anifire.managers.ServerConnector();
			}
			return _instance;
		}
		...
		public function unbind(param1:String, param2:String) : void
		{
			...
			var _loc3_:int = int(this._events.length);
			var _loc4_:int = _loc3_;
			while(_loc4_ >= 0)
			{
				if((_loc5_ = this._events[_loc4_]).eventName == param1 && _loc5_.callback == param2)
				{
		...
		public function notifyEvent(param1:String, param2:Object = null) : void
		{
			...
			while(_loc4_ < _loc3_)
			{
				if((_loc5_ = this._events[_loc4_]).eventName == param1)
				{
		...
		public function startHeartbeat(param1:String = null) : void
		{
			...
			if(!_loc2_["movieId"] && Boolean(param1))
			{
		...
		{
			var _loc1_:URLVariables = anifire.managers.AppConfigManager.instance.createURLVariables();
