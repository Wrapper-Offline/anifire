package com.jumpeye.flashEff2.text.xyResolve
{
   ...
   public class FETXYResolve extends IFlashEffText
   {
      ...
      {
         var _loc2_:Number = Number(param1.blurProp);
      ...
      protected function startTransition(param1:Boolean = true) : void
      {
         ...
         var _loc9_:Number = Number(_loc5_.maxItems);
         ...
         while(_loc6_ < _loc3_)
         {
            _loc16_ = uint(_loc4_[_loc6_].length);
      ...
      protected function clearProperties() : void
      {
         ...
         if(this.elements is Array)
         {
            ...
            while(_loc2_ < _loc1_)
            {
               _loc4_ = uint(this.elements[_loc2_].length);
               _loc3_ = 0;
               while(_loc3_ < _loc4_)
               {
