package anifire.constant
{
	...
	public class CcLibConstant
	{
		...
		public static function get OPTIONAL_COMPONENTS() : UtilHashArray
		{
			...
			_loc1_.push(COMPONENT_TYPE_UPPER_BODY,COMPONENT_TYPE_UPPER_BODY);
			_loc1_.push(LIBRARY_TYPE_GOUPPER,LIBRARY_TYPE_GOUPPER);
			_loc1_.push(COMPONENT_TYPE_LOWER_BODY,COMPONENT_TYPE_LOWER_BODY);
			_loc1_.push(LIBRARY_TYPE_GOLOWER,LIBRARY_TYPE_GOLOWER);
