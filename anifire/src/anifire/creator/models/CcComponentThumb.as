package anifire.creator.models
{
   ...
   public class CcComponentThumb extends EventDispatcher
   {
      ...
      public static function createBodyShapeComponentThumb(param1:anifire.creator.models.CcBodyShape) : anifire.creator.models.CcComponentThumb
      {
         var _loc2_:anifire.creator.models.CcComponentThumb = new anifire.creator.models.CcComponentThumb();
      ...
      private function addMyOwnColor(param1:anifire.creator.models.CcColorThumb) : void
      {
      ...
      public function getMyOwnColorByIndex(param1:int) : anifire.creator.models.CcColorThumb
      {
         return this._myOwnColors.getValueByIndex(param1);
      }
      
      private function addState(param1:anifire.creator.models.CcState) : void
      {
         this._states.push(param1.stateId,param1);
      }
      
      public function getStateByStateId(param1:String) : anifire.creator.models.CcState
      {
         return this._states.getValueByKey(param1) as anifire.creator.models.CcState;
      }
      ...
      public function deSerialize(param1:XML, param2:String, param3:int, param4:String) : void
      {
         ...
         var _loc9_:anifire.creator.models.CcColorThumb = null;
         var _loc10_:anifire.creator.models.CcState = null;
         ...
         this._tags = {};
         for each(_loc5_ in param1.child(anifire.creator.models.CcComponent.XML_TAG_NODE_NAME))
         {
            _loc8_ = String(_loc5_.toString().replace(/^\s*([^\s]*)\s*$/,"$1"));
            this._tags[_loc8_] = 1;
         }
         for each(_loc6_ in param1.child(anifire.creator.models.CcColorThumb.XML_NODE_NAME))
         {
            (_loc9_ = new anifire.creator.models.CcColorThumb()).deSerialize(_loc6_,this.type);
            this.addMyOwnColor(_loc9_);
         }
         for each(_loc7_ in param1.child(anifire.creator.models.CcState.XML_NODE_NAME))
         {
            (_loc10_ = new anifire.creator.models.CcState()).deserialize(_loc7_);
            this.addState(_loc10_);
         }
         if(param1.child(anifire.creator.models.CcComponent.XML_TEMPLATE_NAME).length() > 0)
         {
         }
      }
      ...
      {
         var _loc2_:anifire.creator.models.CcState = this.getStateByStateId(param1);
      ...
      private function onLoadStateImageDataComplete(param1:Event) : void
      {
         ...
         var _loc2_:anifire.creator.models.CcState = param1.target as anifire.creator.models.CcState;
