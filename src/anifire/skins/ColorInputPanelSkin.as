package anifire.skins
{
   ...
   public class ColorInputPanelSkin extends Skin implements IBindingClient
   {
      ...
      public function ColorInputPanelSkin()
      {
         ...
         this._embed_mxml__styles_images_colorpalette_color_input_panel_gradient_png_1209506624 = anifire.skins.ColorInputPanelSkin__embed_mxml__styles_images_colorpalette_color_input_panel_gradient_png_1209506624;
         this._embed_mxml__styles_images_colorpalette_slider_control_png_381158866 = anifire.skins.ColorInputPanelSkin__embed_mxml__styles_images_colorpalette_slider_control_png_381158866;
         ...
         bindings = this._ColorInputPanelSkin_bindingsSetup();
         watchers = [];
         target = this;
         ...
         {
            return anifire.skins.ColorInputPanelSkin[param1];
         },bindings,watchers);
      ...
      {
         anifire.skins.ColorInputPanelSkin._watcherSetupUtil = param1;
      }
      ...
      private function _ColorInputPanelSkin_VSlider1_i() : VSlider
      {
         ...
         _loc1_.setStyle("skinClass",anifire.skins.ColorInputPanelHueSliderSkin);
         _loc1_.id = "hueSlider";
         if(!_loc1_.document)
         {
            _loc1_.document = this;
      ...
      private function _ColorInputPanelSkin_Button1_i() : Button
      {
         ...
         _loc1_.setStyle("skinClass",anifire.skins.EyeDropperButtonSkin);
