package com.jumpeye.flashEff2.symbol.brightSquares
{
   ...
   public class FESBrightSquares extends IFlashEffSymbol
   {
      ...
      private var oJFESBrightSquaresPresets:com.jumpeye.flashEff2.symbol.brightSquares.JFESBrightSquaresPresets;
      ...
      public function FESBrightSquares(param1:JUIComponent = null)
      {
         ...
         oJFESBrightSquaresPresets = new com.jumpeye.flashEff2.symbol.brightSquares.JFESBrightSquaresPresets();
         super();
      ...
      private function applyTransition(param1:String) : void
      {
         ...
         _loc6_ = lines * columns != 1 ? (this._tweenDuration - this._groupDuration) / _loc5_.max : 0;
         if(param1 == "show")
         {
