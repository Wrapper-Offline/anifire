package anifire.creator.models
{
   ...
   public class CcComponent
   {
      ...
      public var componentThumb:anifire.creator.models.CcComponentThumb;
      ...
      public function clone() : anifire.creator.models.CcComponent
      {
         var _loc1_:anifire.creator.models.CcComponent = new anifire.creator.models.CcComponent();
         _loc1_.x = this.x;
         _loc1_.y = this.y;
      ...
      public function deserialize(param1:XML, param2:UtilHashArray) : void
      {
         ...
         var _loc6_:anifire.creator.models.CcTheme = param2.getValueByKey(_loc3_) as anifire.creator.models.CcTheme;
         if(CcLibConstant.ALL_BODY_COMPONENT_TYPES.indexOf(_loc4_) >= 0)
         {
            this.componentThumb = _loc6_.getComponentThumbWithinBodyshapeByType(_loc4_).getValueByKey(anifire.creator.models.CcComponentThumb.generateInternalId(_loc4_,_loc5_)) as anifire.creator.models.CcComponentThumb;
         }
         else
         {
            this.componentThumb = _loc6_.getComponentThumbByType(_loc4_).getValueByKey(anifire.creator.models.CcComponentThumb.generateInternalId(_loc4_,_loc5_)) as anifire.creator.models.CcComponentThumb;
         }
         this.x = param1.@x;
         this.y = param1.@y;
