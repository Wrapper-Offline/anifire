package anifire.creator.core
{
   ...
   public class CcConsole implements IEventDispatcher
   {
      ...
      public static function initializeCcConsole(param1:ICcMainUiContainer, param2:ICcCharEditorContainer, param3:ICcPreviewAndSaveContainer) : anifire.creator.core.CcConsole
      {
         if(_cc_console == null)
         {
            _cc_console = new anifire.creator.core.CcConsole(param1,param2,param3);
         }
         return _cc_console;
      }
      
      public static function getCcConsole() : anifire.creator.core.CcConsole
      {
         if(_cc_console != null)
         {
            return _cc_console;
