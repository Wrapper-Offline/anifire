package com.jumpeye.flashEff2.text.wigiligi
{
   ...
   public class FETWigiligi extends IFlashEffText
   {
      ...
      protected function clearProperties() : void
      {
         ...
         if(owner is Object)
         {
            if(owner.elements is Array)
            {
               ...
               _loc3_ = uint(owner.elements.length);
               ...
               while(_loc4_ < _loc3_)
               {
                  _loc6_ = uint(owner.elements[_loc4_].length);
                  _loc5_ = 0;
                  while(_loc5_ < _loc6_)
                  {
      ...
      public function set maxBlurY(param1:Number) : void
      {
         ...
         this._maxBlurY = Number(param1) || 0;
      }
      ...
      public function set subGrupDuration(param1:Number) : void
      {
         ...
         this._subGrupDuration = Number(param1) || 1;
      }
      ...
      protected function startTransition(param1:Boolean = true) : void
      {
         ...
         var _loc12_:Number = Number(Number(this.preset) || 1);
         obj = {};
         ...
         {
            _loc15_ = uint(_loc6_[_loc10_].length);
            ...
            while(_loc11_ < _loc15_)
            {
               ...
               _loc18_ = Number(elementObject.clip.getBounds(elementObject.clip).x);
               _loc19_ = Number(elementObject.clip.getBounds(elementObject.clip).y);
