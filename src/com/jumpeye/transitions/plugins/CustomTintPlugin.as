package com.jumpeye.transitions.plugins
{
   ...
   public class CustomTintPlugin extends TweenPlugin
   {
      ...
      protected var _matrixTween:com.jumpeye.transitions.plugins.EndArrayPlugin;
      ...
      override public function onInitTween(param1:Object, param2:*, param3:TweenLite) : Boolean
      {
         ...
         var _loc7_:Number = Number(_loc4_.amount);
         if(isNaN(_loc7_))
         {
            _loc7_ = 1;
         }
         _loc5_.setTint(uint(_loc4_.tintColor) || this._color.tintColor,_loc7_);
