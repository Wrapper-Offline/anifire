      ...
      protected function drawSquares(param1:uint, param2:Number) : void
      {
         ...
         while(_loc9_ < this.lin)
         {
            ...
            while(_loc11_ < this.col)
            {
               ...
               (_loc14_ = new Sprite()).name = "clip" + _loc9_ + "_" + _loc11_;
               ...
               (_loc18_ = new Matrix()).translate(-_loc5_ / this.target.scaleX - targetBounds.x,-_loc6_ / this.target.scaleY - targetBounds.y);
