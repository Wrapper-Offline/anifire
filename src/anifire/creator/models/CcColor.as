package anifire.creator.models
{
   ...
   public class CcColor
   {
      ...
      public var ccColorThumb:anifire.creator.models.CcColorThumb;
      
      public var colorValue:uint;
      
      public var ccComponent:anifire.creator.models.CcComponent;
      ...
      public function clone() : anifire.creator.models.CcColor
      {
         var _loc1_:anifire.creator.models.CcColor = new anifire.creator.models.CcColor();
      ...
      public function deserialize(param1:XML, param2:anifire.creator.models.CcTheme, param3:anifire.creator.models.CcCharacter) : Boolean
      {
         this.colorValue = uint(Number(param1.toString()));
         this.ccColorThumb = param2.getColorThumbByInternalId(anifire.creator.models.CcColorThumb.generateInternalId(param1.@r));
