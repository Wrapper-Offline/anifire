package Singularity.Geom
{
   ...
   public class Composite extends EventDispatcher
   {
      ...
      protected var __spline:Singularity.Geom.FastCubicSpline;
      ...
      public function Composite()
      {
         ...
         this.__spline = new Singularity.Geom.FastCubicSpline();
      ...
      public function draw(param1:Number = 1, param2:Number = 3, param3:Number = 3, param4:Number = 15) : void
      {
