package com.jumpeye.flashEff2.text.slideBounce
{
   ...
   public class FETSlideBounce extends IFlashEffText
   {
      ...
      protected function startTransition(param1:Boolean = true) : void
      {
         ...
         angle = bounceAngle;
         var _loc8_:Number = Number(Number(this.preset) || 9);
         if(Number(_loc8_) > 50)
         {
            _loc8_ = 9;
         }
         _loc9_ = (_loc8_ = Math.max(1,_loc8_)) < 26 ? "chars" : "words";
         _loc8_ = _loc8_ > 26 ? _loc8_ - 25 : _loc8_;
         ...
         while(_loc6_ < _loc3_)
         {
            _loc10_ = uint(_loc2_[_loc6_].length);
      ...
      {
         var _loc3_:Number = param2 == 1 ? param1 : 0;
         var _loc4_:Number = param2 == 1 ? 0 : param1;
