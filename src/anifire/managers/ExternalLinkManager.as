package anifire.managers
{
	...
	public class ExternalLinkManager
	{
		...
		private static var __instance:anifire.managers.ExternalLinkManager;
		...
		public static function get instance() : anifire.managers.ExternalLinkManager
		{
			if(!__instance)
			{
				__instance = new anifire.managers.ExternalLinkManager();
			}
			return __instance;
		}
