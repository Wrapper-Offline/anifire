package com.jumpeye.flashEff2.text.jiggy
{
   ...
   public class FETJiggy extends IFlashEffText
   {
      ...
      private function getBlurShadow(param1:*, param2:*, param3:*, param4:*, param5:*, param6:*) : *
      {
         ...
         var _loc11_:Number = _loc7_ == 1 ? 0 : param1 / 5;
         var _loc12_:Number = _loc7_ == 1 ? param1 / 5 : 0;
      ...
      public function set maxBlurX(param1:Number) : void
      {
         ...
         this._maxBlurX = Number(param1) || 0;
      }
      ...
      protected function clearProperties(param1:*) : void
      {
         ...
         {
            _loc2_ = this.component.absMatrix;
            _loc3_ = uint(param1.elements.length);
            _loc4_ = 0;
            while(_loc4_ < _loc3_)
            {
               _loc6_ = uint(param1.elements[_loc4_].length);
               _loc5_ = 0;
               while(_loc5_ < _loc6_)
               {
      ...
      {
         var _loc3_:Number = param2 == 1 ? 0 : param1 / 3;
         var _loc4_:Number = param2 == 1 ? param1 / 3 : 0;
