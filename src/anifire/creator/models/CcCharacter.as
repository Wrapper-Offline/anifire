package anifire.creator.models
{
   ...
   public class CcCharacter
   {
      ...
      private var _bodyShape:anifire.creator.models.CcBodyShape;
      ...
      private var _currentTheme:anifire.creator.models.CcTheme;
      ...
      public function set currentTheme(param1:anifire.creator.models.CcTheme) : void
      {
         this._currentTheme = param1;
      }
      
      public function get currentTheme() : anifire.creator.models.CcTheme
      {
      ...
      public function set bodyShape(param1:anifire.creator.models.CcBodyShape) : void
      {
         this._bodyShape = param1;
      }
      
      public function get bodyShape() : anifire.creator.models.CcBodyShape
      {
      ...
      public function clone() : anifire.creator.models.CcCharacter
      {
         var _loc1_:int = 0;
         var _loc3_:anifire.creator.models.CcColor = null;
         var _loc4_:anifire.creator.models.CcComponent = null;
         var _loc5_:anifire.creator.models.CcLibrary = null;
         var _loc2_:anifire.creator.models.CcCharacter = new anifire.creator.models.CcCharacter();
      ...
      public function cloneFromSourceToMe(param1:anifire.creator.models.CcCharacter) : void
      {
         var _loc2_:int = 0;
      ...
      public function getUserChosenLibraryByIndex(param1:Number) : anifire.creator.models.CcLibrary
      {
      ...
      public function addUserChosenLibrary(param1:anifire.creator.models.CcLibrary) : void
      {
         this.removeUserChosenLibraryByType(param1.type);
         this._userChosenLibraries.push(param1);
      }
      
      public function getUserChosenLibraryByType(param1:String) : anifire.creator.models.CcLibrary
      {
         var _loc3_:anifire.creator.models.CcLibrary = null;
         var _loc2_:int = int(this._userChosenLibraries.length - 1);
         while(_loc2_ >= 0)
         {
            _loc3_ = this._userChosenLibraries[_loc2_] as anifire.creator.models.CcLibrary;
      ...
      public function addUserChosenColor(param1:anifire.creator.models.CcColor) : void
      {
         var _loc2_:String = null;
      ...
      public function getUserChosenColorByColorReference(param1:String) : anifire.creator.models.CcColor
      {
         var _loc2_:anifire.creator.models.CcColor = null;
         var _loc3_:int = 0;
         while(_loc3_ < this._userChosenColors.length)
         {
            _loc2_ = this._userChosenColors.getValueByIndex(_loc3_) as anifire.creator.models.CcColor;
      ...
      public function getUserChosenColorByComponentType(param1:String) : Array
      {
         ...
         {
            _loc3_ = this._userChosenColors.getValueByIndex(_loc4_) as anifire.creator.models.CcColor;
      ...
      public function getUserChosenColorByIndex(param1:int) : anifire.creator.models.CcColor
      {
      ...
      public function getUserChosenComponentByIndex(param1:int) : anifire.creator.models.CcComponent
      {
         return this._userChosenComponents[param1] as anifire.creator.models.CcComponent;
      }
      
      public function getUserChosenComponentByComponentType(param1:String) : Array
      {
         var _loc3_:anifire.creator.models.CcComponent = null;
         var _loc2_:Array = new Array();
         var _loc4_:int = 0;
         while(_loc4_ < this._userChosenComponents.length)
         {
            _loc3_ = this._userChosenComponents[_loc4_] as anifire.creator.models.CcComponent;
      ...
      public function addUserChosenComponent(param1:anifire.creator.models.CcComponent) : void
      {
      ...
      public function getFacialByFacialId(param1:String) : anifire.creator.models.CcFacial
      {
      ...
      {
         var _loc4_:anifire.creator.models.CcLibrary = null;
         var _loc5_:anifire.creator.models.CcComponent = null;
         var _loc2_:int = int(this._userChosenLibraries.length - 1);
         while(_loc2_ >= 0)
         {
            if((_loc4_ = this._userChosenLibraries[_loc2_] as anifire.creator.models.CcLibrary).type == param1)
            {
               this._userChosenLibraries.splice(_loc2_,1);
            }
            _loc2_--;
         ...
         while(_loc3_ >= 0)
         {
            if((_loc5_ = this._userChosenComponents[_loc3_] as anifire.creator.models.CcComponent).componentThumb.type == param1)
            {
      ...
      public function removeUserChosenComponentById(param1:String) : void
      {
         ...
         while(_loc2_ >= 0)
         {
            if((_loc4_ = this._userChosenComponents[_loc2_] as anifire.creator.models.CcComponent).id == param1)
            {
         ...
         while(_loc3_ >= 0)
         {
            if((_loc5_ = this._userChosenColors.getValueByIndex(_loc3_) as anifire.creator.models.CcColor).ccComponent != null && _loc5_.ccComponent.id == param1)
            {
      ...
      public function transformBodyShape(param1:anifire.creator.models.CcBodyShape) : void
      {
         var _loc2_:anifire.creator.models.CcComponent = null;
         var _loc3_:anifire.creator.models.CcComponent = null;
         var _loc4_:String = null;
         var _loc5_:anifire.creator.models.CcComponentThumb = null;
         ...
         {
            this._bodyShape = param1;
            _loc2_ = new anifire.creator.models.CcComponent();
            _loc2_.componentThumb = anifire.creator.models.CcComponentThumb.createBodyShapeComponentThumb(this.bodyShape);
            this.addUserChosenComponent(_loc2_);
            _loc3_ = new anifire.creator.models.CcComponent();
            _loc4_ = this.ver < 2 ? CcLibConstant.COMPONENT_TYPE_SKELETON : CcLibConstant.COMPONENT_TYPE_FREEACTION;
            _loc5_ = this.bodyShape.getComponentThumbByType(_loc4_).getValueByIndex(0) as anifire.creator.models.CcComponentThumb;
            ...
            for each(_loc6_ in CcLibConstant.USER_CHOOSE_ABLE_BODY_COMPONENT_TYPES)
            {
               if(_loc6_ != CcLibConstant.COMPONENT_TYPE_BODYSHAPE)
               {
                  ...
                  {
                     _loc8_ = this.bodyShape.getComponentThumbByType(_loc6_).getValueByIndex(0) as anifire.creator.models.CcComponentThumb;
      ...
      public function randomize(param1:anifire.creator.models.CcTheme, param2:String, param3:anifire.creator.models.CcBodyShape = null) : void
      {
         var _loc4_:int = 0;
         var _loc5_:Boolean = false;
         var _loc6_:anifire.creator.models.CcCharacter = null;
         ...
         else
         {
            ...
            if(param1.preMadeChars)
            {
               ...
               {
                  if((_loc6_ = param1.preMadeChars[_loc4_] as anifire.creator.models.CcCharacter).bodyShape.bodyType == param2)
                  {
                     _loc5_ = false;
                     break;
                  }
      ...
      private function randomizeFromPreMadeChar(param1:anifire.creator.models.CcTheme, param2:String) : void
      {
         var _loc4_:anifire.creator.models.CcCharacter = null;
         var _loc3_:Array = new Array();
         var _loc5_:int = 0;
         while(_loc5_ < param1.preMadeChars.length)
         {
            if((_loc4_ = param1.preMadeChars[_loc5_] as anifire.creator.models.CcCharacter).bodyShape.bodyType == param2 && CcLibConstant.CHAR_TAG_MATCH_CURR_THEME(_loc4_.tags))
            {
               _loc3_.push(_loc4_);
            }
            _loc5_++;
         ...
         (_loc4_ = _loc3_[_loc6_] as anifire.creator.models.CcCharacter).markAsTemplate();
      ...
      private function randomizeEverythingRandomlly(param1:anifire.creator.models.CcTheme, param2:String, param3:anifire.creator.models.CcBodyShape = null) : void
      {
         var _loc4_:String = null;
         var _loc5_:UtilHashArray = null;
         var _loc6_:anifire.creator.models.CcComponentThumb = null;
         var _loc7_:anifire.creator.models.CcColorThumb = null;
         var _loc8_:anifire.creator.models.CcColor = null;
         var _loc10_:int = 0;
         var _loc13_:anifire.creator.models.CcComponentThumb = null;
         ...
         while(_loc10_ < param1.getColorThumbNum())
         {
            ...
            {
               (_loc8_ = new anifire.creator.models.CcColor()).ccColorThumb = _loc7_;
         ...
         if(param3 == null)
         {
            this._bodyShape = _loc9_[Math.floor(Math.random() * _loc9_.length)] as anifire.creator.models.CcBodyShape;
         }
         else
         {
            this._bodyShape = param3;
         }
         var _loc11_:anifire.creator.models.CcComponent;
         (_loc11_ = new anifire.creator.models.CcComponent()).componentThumb = anifire.creator.models.CcComponentThumb.createBodyShapeComponentThumb(this.bodyShape);
         this.addUserChosenComponent(_loc11_);
         var _loc12_:anifire.creator.models.CcComponent = new anifire.creator.models.CcComponent();
         switch(this.ver)
         {
            case 2:
               _loc13_ = this.bodyShape.getComponentThumbByType(CcLibConstant.COMPONENT_TYPE_FREEACTION).getValueByIndex(0) as anifire.creator.models.CcComponentThumb;
               break;
            default:
               _loc13_ = this.bodyShape.getComponentThumbByType(CcLibConstant.COMPONENT_TYPE_SKELETON).getValueByIndex(0) as anifire.creator.models.CcComponentThumb;
         }
      ...
      private function randomlyChooseComponentInArray(param1:UtilHashArray, param2:String) : void
      {
         ...
         var _loc5_:anifire.creator.models.CcComponent = null;
         var _loc6_:anifire.creator.models.CcColorThumb = null;
         var _loc7_:anifire.creator.models.CcColor = null;
         var _loc8_:anifire.creator.models.CcLibrary = null;
         if(param1 != null && param1.length > 0)
         {
            ...
            while(_loc3_ >= 0)
            {
               if(!(_loc4_ = param1.getValueByIndex(_loc3_) as anifire.creator.models.CcComponentThumb).is_randomable || !_loc4_.enable)
               {
                  param1.remove(_loc3_,1);
               }
               _loc3_--;
            }
            _loc4_ = param1.getValueByIndex(Math.random() * param1.length) as anifire.creator.models.CcComponentThumb;
            _loc5_ = new anifire.creator.models.CcComponent();
            _loc5_.xscale = _loc5_.yscale = anifire.creator.models.CcCharacter.getComponentScaling(param2);
            ...
            while(_loc3_ < _loc4_.getMyOwnColorNum())
            {
               ...
               (_loc7_ = new anifire.creator.models.CcColor()).ccColorThumb = _loc6_;
      ...
      public function deserialize(param1:XML, param2:UtilHashArray) : void
      {
         ...
         var _loc11_:anifire.creator.models.CcComponent = null;
         var _loc12_:anifire.creator.models.CcComponentThumb = null;
         ...
         {
            if((_loc8_ = anifire.creator.models.CcComponent.getComponentThumbTypeFromXml(_loc3_)) == CcLibConstant.COMPONENT_TYPE_BODYSHAPE)
            {
               _loc9_ = anifire.creator.models.CcComponent.getComponentThemeIdFromXml(_loc3_);
               _loc10_ = anifire.creator.models.CcComponent.getComponentIdFromXml(_loc3_);
               this._bodyShape = (param2.getValueByKey(_loc9_) as anifire.creator.models.CcTheme).getBodyShapeByShapeId(_loc10_);
               this.currentTheme = param2.getValueByKey(_loc9_) as anifire.creator.models.CcTheme;
               (_loc11_ = new anifire.creator.models.CcComponent()).componentThumb = anifire.creator.models.CcComponentThumb.createBodyShapeComponentThumb(this.bodyShape);
               this.addUserChosenComponent(_loc11_);
            }
            else
