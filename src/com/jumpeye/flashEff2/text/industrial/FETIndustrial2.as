package com.jumpeye.flashEff2.text.industrial
{
   ...
   public class FETIndustrial2 extends IFlashEffText
   {
      ...
      protected function motionChange() : void
      {
         ...
         var _loc5_:uint = uint(propOwner.timeline.frames[_loc4_].length);
         var _loc6_:Number = Number(_loc3_.prop);
         _loc1_ = 0;
         while(_loc1_ < _loc5_)
         {
            ...
            _loc10_ = Number(_loc7_.clip[_loc8_.blurRel]);
         ...
         _loc5_ = uint(propOwner.alphaElements.length);
         _loc1_ = 0;
         while(_loc1_ < _loc5_)
         {
      ...
      protected function startTransition(param1:Boolean = true) : void
      {
         ...
         var _loc9_:uint = uint(this.target.numLines);
         var _loc10_:Array = [];
         ...
         while(_loc7_ < _loc9_)
         {
            ...
            if((_loc15_ = this.target.getLineLength(_loc7_)) > 0)
            {
               ...
               {
                  _loc17_ = uint(_loc10_[_loc7_].push(Math.floor(Math.random() * this.maxChars + 1)));
                  _loc14_ += _loc10_[_loc7_][_loc17_ - 1];
               }
               _loc16_ = uint(_loc10_[_loc7_].length);
         ...
         while(_loc4_ < _loc3_)
         {
            _loc18_ = uint(_loc2_[_loc4_].length);
            ...
            while(_loc5_ < _loc18_)
            {
               ...
               _loc21_ = (_loc20_ = Number(_loc19_.clip.width)) / 2;
               for(_loc22_ in _loc19_.effect)
               {
                  _loc23_ = uint(_loc19_.elementTimeline.push({
                  ...
                  _loc25_ = String(_loc19_.effect[_loc22_]);
                  if(!(propOwner.timeline[_loc25_] is Array))
                  {
                     ++propOwner.timeline.len;
                     _loc26_ = uint(propOwner.timeline.frames.push([]));
         ...
         while(_loc4_ < propOwner.timeLen)
         {
            ...
            while(_loc5_ < propOwner.timeline.frames[_loc4_].length)
            {
               ...
               _loc29_ = String(_loc19_.effect[_loc28_.effectIndex]);
               ...
               {
                  if((_loc30_ = String(_loc19_.effect[_loc28_.effectIndex])) == "up" || _loc30_ == "down")
                  {
      ...
      protected function motionFinish() : void
      {
         ...
         {
            _loc1_ = uint(propOwner.timeline.frames[propOwner.currentLevel].length);
            _loc2_ = 0;
            while(_loc2_ < _loc1_)
            {
            ...
            _loc1_ = uint(propOwner.alphaElements.length);
            _loc2_ = 0;
            while(_loc2_ < _loc1_)
            {
